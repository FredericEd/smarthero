...
class BitacorasListaFragment: Fragment(), BitacorasUIObserver{
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        bitacoraAdapter = BitacoraAdapter(this, activity!!.applicationContext, bitacorasList!!)
    ...
    private fun loadContactos(){
        if (NetworkUtils.isConnected(context!!)) {
            ...
            val stringRequest = object : StringRequest(Method.GET, "${Utils.URL_SERVER}/bitacoras",
                Response.Listener<String> { response ->
                    if (isAdded) {
                        try {
                            ...
                            Toast.makeText(this@BitacorasListaFragment.context, resources.getString(R.string.error_general), Toast.LENGTH_LONG).show()
                            e.printStackTrace()
                        }
                    }
